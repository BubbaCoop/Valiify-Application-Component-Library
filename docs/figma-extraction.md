...
**Status**: Pipeline live, extraction PENDING for the Short App. This
document is the reference for running it — it was proven on the dashboard library.
...
```bash
claude --skill figma:figma-use "Extract all design tokens from the Short App component library"
```
