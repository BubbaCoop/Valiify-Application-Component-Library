...
Then run, once:
  node val/tools/design/class-audit.mjs 02-concept/concept.v<n>.html --library . --methodology <methodology path> --tailwind-from . --package @valiify/shortapp-ui --class-prefix va
