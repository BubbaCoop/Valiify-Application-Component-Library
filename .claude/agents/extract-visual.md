...
description: >
  ...
  session scratchpad ONLY — never the repo, never Val's val/runs/.
...
You never write to the repo or to val/runs/ — downloads and analysis
...
2. Measure with a script (node + pngjs is available — it is a dependency of
   ...
   node_modules/@valiify/val-core/skills/visual-verification/SKILL.md:
