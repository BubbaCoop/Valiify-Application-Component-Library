...
- `tokens/figma-tokens.json` — which variables already exist; list the NEW
  ...
  both conventions.
- `.claude/skills/valiify-shortapp-ui/SKILL.md` — this library's tokens, casing decisions
...
- `CLAUDE.md` "Token extraction lessons" and "CSS traps" sections — the
  ...
  those lessons is `node_modules/@valiify/val-core/skills/extract-methodology/SKILL.md`.
