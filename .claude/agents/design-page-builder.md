...
model: inherit
---
<!-- GENERATED by @valiify/val-core@0.5.0 from val/config.json (library: shortapp). Do not edit — change the template in node_modules/@valiify/val-core/templates/ or the config, then run `npx val-init`. -->
...
Run, once each:
  ...
  node val/tools/design/class-audit.mjs 05-package --library . --methodology <methodology path> --tailwind-from . --package @valiify/shortapp-ui --class-prefix va
