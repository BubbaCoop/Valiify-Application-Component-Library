...
val/tools/qa/example.spec.mjs: it imports val/tools/qa/harness.mjs
...
val/tools/qa/standing.mjs (S01–S06: hover, expand/collapse, sticky,
...
Library probe hooks for Short App: none configured (optional: set paths.qaProbes in val/config.json to a module exporting library probe hooks) —
...
lessons are in node_modules/@valiify/val-core/skills/visual-verification/SKILL.md §3.
